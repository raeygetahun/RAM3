...
export default function Careers() {
  ...
  const filteredJobs = filter ? jobListings.filter((job) => job.department === filter) : jobListings
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-[#003366] text-white">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Build your career with a company that values innovation, teamwork, and excellence.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: "Join a team that values collaboration, respect, and open communication.",
              },
              {
                icon: <Award className="h-10 w-10 text-[#FF6600]" />,
                title: "Professional Growth",
                description: "We invest in our employees through training, mentorship, and advancement opportunities.",
              },
              {
                icon: <Heart className="h-10 w-10 text-[#FF6600]" />,
                title: "Comprehensive Benefits",
                description: "Enjoy competitive pay, health insurance, retirement plans, and paid time off.",
              },
              {
      ...
      <section className="py-16 bg-[#F2F2F2]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#003366] mb-4">Current Openings</h2>
            <p className="text-[#333333] max-w-2xl mx-auto">
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded-full ${!filter ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              All Departments
            </button>
            <button
              onClick={() => setFilter("Operations")}
              className={`px-4 py-2 rounded-full ${filter === "Operations" ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              Operations
            </button>
            <button
              onClick={() => setFilter("Warehousing")}
              className={`px-4 py-2 rounded-full ${filter === "Warehousing" ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              Warehousing
            </button>
            <button
              onClick={() => setFilter("Maintenance")}
              className={`px-4 py-2 rounded-full ${filter === "Maintenance" ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              Maintenance
            </button>
            <button
              onClick={() => setFilter("Customer Service")}
              className={`px-4 py-2 rounded-full ${filter === "Customer Service" ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              Customer Service
            </button>
            <button
              onClick={() => setFilter("Sales")}
              className={`px-4 py-2 rounded-full ${filter === "Sales" ? "bg-[#003366] text-white" : "bg-white text-[#333333] hover:bg-[#99CCFF]"}`}
            >
              Sales
            </button>
          </div>
            ...
            {filteredJobs.map((job, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <Button className="bg-[#FF6600] hover:bg-[#FF6600]/90 text-white mt-4 md:mt-0">Apply Now</Button>
                </div>
                ...
                <div>
                  <h4 className="font-bold text-[#003366] mb-2">Requirements:</h4>
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={index} className="relative">
                    ...
                    <div
                      className={`ml-20 md:ml-0 ${index % 2 === 0 ? "md:mr-[50%] md:pr-8 md:text-right" : "md:ml-[50%] md:pl-8"}`}
                    >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "I've been driving for TransCargo for over 5 years, and it's the best company I've worked for in my 15-year career. They truly care about their drivers' wellbeing and provide the support we need on the road.",
                name: "Michael Johnson",
                position: "CDL Driver",
                years: "5 years with TransCargo",
              ...
              },
              {
                ...
                years: "3 years with TransCargo",
                image: "/placeholder.svg?height=100&width=100",
              },
              {
                quote:
                  "What I appreciate most about working at TransCargo is the collaborative environment. Everyone from warehouse staff to executives works together to solve problems and deliver for our customers.",
                name: "David Chen",
                position: "Warehouse Supervisor",
                years: "4 years with TransCargo",
                image: "/placeholder.svg?height=100&width=100",
              },
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-[#333333] text-sm">{testimonial.position}</p>
                    <p className="text-[#333333] text-xs">{testimonial.years}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="max-w-2xl mx-auto">
                If you have questions about our open positions or the application process, feel free to reach out to our
                HR team.
              </p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <Button type="submit" className="bg-[#FF6600] hover:bg-[#FF6600]/90 text-white w-full py-6">
                Send Message
              </Button>
            </form>
          </div>
